...
def test_w01_multiple_coins(test_trading_features_df):
    ...
    # crypto_outflows: no sells = 0
    expected_sells = 0

    # crypto_net_flows: 400 - 0 = 400
    expected_net = 400
    ...
    assert wallet_features['crypto_inflows'] == expected_buys
    assert wallet_features['crypto_outflows'] == expected_sells
...
def test_w08_offsetting_transactions(test_trading_features_df):
    ...
    # crypto_outflows: 10000 sell = 10000
    expected_sells = 10000

    # crypto_net_flows: 10000 - 10000 = 0
    expected_net = 500
...
def test_w09_memecoin_winner(test_trading_features_df):
    ...
    # crypto_outflows: 500 + 100 = 600 in sells
    expected_sells = 600

    # crypto_net_flows: 100 - 600 = -500
    expected_net = -500
