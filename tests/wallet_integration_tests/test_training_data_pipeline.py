...
# ------------------------------------------ #
# retrieve_cleaned_period_datasets() unit tests
# ------------------------------------------ #
...
def period_datasets():
    ...
    training_profits_df, training_market_df, _, coin_cohort = wtdo.retrieve_cleaned_period_datasets(
    ...
    modeling_profits_df, modeling_market_df, _, _ = wtdo.retrieve_cleaned_period_datasets(
    ...
    combined_profits_df, combined_market_df, _, _ = wtdo.retrieve_cleaned_period_datasets(
        wallets_config['training_data']['training_period_start'],
        wallets_config['training_data']['modeling_period_end'],
        coin_cohort=coin_cohort
    )
...
def validation_datasets(period_datasets):
    ...
    validation_profits_df, validation_market_df, _, _ = wtdo.retrieve_cleaned_period_datasets(
    ...
    # Get full range data
    full_range_profits_df, full_range_market_df, _, _ = wtdo.retrieve_cleaned_period_datasets(
        wallets_config['training_data']['training_period_start'],
        wallets_config['training_data']['validation_period_end'],
        coin_cohort=coin_cohort
    )
