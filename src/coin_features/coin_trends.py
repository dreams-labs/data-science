...
def generate_coin_trends_features(
    ...
    Generates flattened coin trends data time series features for coins based on
     data from before the period_end_date. The coin-indexed time series is then
     joined onto hybridized wallet addresses by extracting their component coin_id.
